...
public class Estate extends Car {
    ...
    public Estate(Boolean hasThirdRowSeat, Boolean hasRoofRack, Boolean hasSatNav, Boolean hasParkingSensors, Boolean hasTowBar, CarBodyType carBodyType, String vehicleMake, String vehicleModel, int vehicleYear, VehicleGearBox vehicleGearBox, VehicleColour vehicleColour, int vehicleMileage, int vehicleVIN) {
    ...
    public Boolean getHasThirdRowSeat() {
