...
public class SUV extends Car {
    ...
    public SUV(Boolean hasAllWheelDriveTrain, Boolean hasRoofRack, Boolean hasSatNav, Boolean hasParkingSensors, Boolean hasTowBar, CarBodyType carBodyType, String vehicleMake, String vehicleModel, int vehicleYear, VehicleGearBox vehicleGearBox, VehicleColour vehicleColour, int vehicleMileage, int vehicleVIN) {
        ...
        this.hasAllWheelDriveTrain = hasAllWheelDriveTrain;
    ...
    public String toString() {
        return "\nVehicle Identification Number: " + vehicleVIN + 
                ...
                "\nVehicle has All-Wheel Drivetrain?: " + hasAllWheelDriveTrain.toString();
    }

    public Boolean getHasAllWheelDriveTrain() {
        return hasAllWheelDriveTrain;
    }

    public void setHasAllWheelDriveTrain(Boolean hasAllWheelDriveTrain) {
        this.hasAllWheelDriveTrain = hasAllWheelDriveTrain;
    }
