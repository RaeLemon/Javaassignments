...
public class Saloon extends Car {
    ...
    public Saloon(Boolean hasRoofRack, Boolean hasSatNav, Boolean hasParkingSensors, Boolean hasTowBar, CarBodyType carBodyType, String vehicleMake, String vehicleModel, int vehicleYear, VehicleGearBox vehicleGearBox, VehicleColour vehicleColour, int vehicleMileage, int vehicleVIN) {
